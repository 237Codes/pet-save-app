...
import { MapPin, PawPrint, Coins, Medal, Settings, Home, Car } from "lucide-react"

const sidebarItems = [
  { href: "/", icon: Home, label: "Home" },
  { href: "/report", icon: MapPin, label: "Report Lost Pet" },
  { href: "/collect", icon: PawPrint, label: "Collect Pet" },
